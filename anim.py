...
from PySide6.QtCore import (
    QObject, QTimer, Signal, QPointF, QPropertyAnimation, QEasingCurve,
    Property, QRectF, Qt, QSequentialAnimationGroup,
)
from PySide6.QtWidgets import (
    QApplication, QGraphicsScene, QGraphicsView, QMainWindow,
    QVBoxLayout, QHBoxLayout, QWidget, QPushButton, QGraphicsObject,
    QGraphicsEllipseItem, QGraphicsPolygonItem, QGraphicsRectItem, QGraphicsLineItem,
    QGraphicsTextItem, QComboBox, QLabel, QLineEdit, QSpinBox,
)
